...
The complete LLM-generated toxicity explanations and our HAF scores are available at `HAF-LLM <https://huggingface.co/datasets/llm-toxicity-explanations>`_. The complete LLM output tokens and entropy scores are available upon request.
